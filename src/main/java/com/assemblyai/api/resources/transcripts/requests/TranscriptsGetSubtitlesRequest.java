...
@JsonDeserialize(builder = TranscriptsGetSubtitlesRequest.Builder.class)
public final class TranscriptsGetSubtitlesRequest {
    private final Optional<Integer> charsPerCaption;

    private final Map<String, Object> additionalProperties;

    private TranscriptsGetSubtitlesRequest(
            Optional<Integer> charsPerCaption, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TranscriptsGetSubtitlesRequest && equalTo((TranscriptsGetSubtitlesRequest) other);
    }
    ...
    private boolean equalTo(TranscriptsGetSubtitlesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(TranscriptsGetSubtitlesRequest other) {
        ...
        public TranscriptsGetSubtitlesRequest build() {
            return new TranscriptsGetSubtitlesRequest(charsPerCaption, additionalProperties);
        }
    }
}
