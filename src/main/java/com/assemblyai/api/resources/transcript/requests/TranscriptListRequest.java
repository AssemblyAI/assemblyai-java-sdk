...
public final class TranscriptListRequest {
    ...
    private final Optional<TranscriptListRequestStatus> status;
     ...
     */
    @JsonProperty("status")
    public Optional<TranscriptListRequestStatus> getStatus() {
        return status;
    }
    ...
    public static final class Builder {
        ...
        private Optional<TranscriptListRequestStatus> status = Optional.empty();
        ...
        public Builder status(Optional<TranscriptListRequestStatus> status) {
            this.status = status;
            return this;
        }

        public Builder status(TranscriptListRequestStatus status) {
