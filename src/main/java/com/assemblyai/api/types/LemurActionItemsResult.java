...
public final class LemurActionItemsResult implements ILemurBaseResult {
    private final String requestId;

    private final String response;

    private LemurActionItemsResult(String requestId, String response) {
    ...
    public interface RequestIdStage {
        ...
        Builder from(LemurActionItemsResult other);
    }
