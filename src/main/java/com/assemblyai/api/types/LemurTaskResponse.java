...
public final class LemurTaskResponse implements ILemurBaseResponse {
    ...
    private LemurTaskResponse(String requestId, String response, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LemurTaskResponse && equalTo((LemurTaskResponse) other);
    }
    ...
    private boolean equalTo(LemurTaskResponse other) {
    ...
    public static final class Builder implements RequestIdStage, ResponseStage, _FinalStage {
        ...
        @Override
        public Builder from(LemurTaskResponse other) {
        ...
        public LemurTaskResponse build() {
            return new LemurTaskResponse(requestId, response, additionalProperties);
        }
    }
}
