...
@JsonDeserialize(builder = TranscriptListParameters.Builder.class)
public final class TranscriptListParameters {
    ...
    public static final class Builder {
        ...
        public Builder from(TranscriptListParameters other) {
